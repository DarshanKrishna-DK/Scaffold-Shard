 ...
 * These definitions are used to derive the types needed in the custom scaffold-shard hooks, for example.
...
const generateTsAbis: DeployFunction = async function () {
  ...
  fs.writeFileSync(
    ...
    await prettier.format(
      `${generatedContractComment} import { GenericContractsDeclaration } from "~~/utils/scaffold-shard/contract"; \n\n
